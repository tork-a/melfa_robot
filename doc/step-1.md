...
今回，ロボットの関節角度の取得に「リアルタイムモニタ機能」適用の必要性
を検討したが，「リアルタイム外部制御機能」で取得できる情報はパケットごと
に4種類を指定できるため，たとば関節角度と電流を両方取りたい場合でも，
リアルタイム外部制御機能でロボットの状態を取得可能である．
...
たい場合には，この「リアルタイムモニタ機能」適用の必要がありうる．
...
あとはデフォルトの設定のままでよく，「完了」ボタンを押して終了する．
